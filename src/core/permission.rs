...
/// Checks input-device access and escalates privileges if needed.
///
/// # Errors
/// Returns an error if privilege escalation fails or the underlying helper
/// cannot determine the required access state.
